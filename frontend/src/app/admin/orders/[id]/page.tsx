...
export default function OrderDetailsPage() {
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      ...
      alert(
        err.message ||
          "Status update failed. Backend route may need configuration.",
      );
      // Revert on failure
      fetchOrderDetails(orderId);
    } finally {
  ...
  if (error || !order) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white p-8 text-center">
        ...
        <Link
          href="/admin"
          className="px-6 py-3 border border-white hover:bg-white hover:text-black transition-colors tracking-widest text-sm font-bold uppercase"
        >
          Return to Dashboard
        </Link>
      </div>
    ...
    <main className="w-full min-h-screen bg-black pt-32 pb-24 px-4 sm:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12 border-b border-zinc-900 pb-8">
          <div>
            <h1
              className="text-4xl font-black tracking-widest uppercase mb-2 text-white"
              style={{ fontFamily: "var(--font-koulen), Impact, sans-serif" }}
            >
            ...
            <div className="bg-[#050505] border border-zinc-900 p-8">
              ...
              <div className="space-y-6">
                {order.items.map((item: any, idx) => (
                  <div
                    key={idx}
                    className="flex gap-6 border-b border-zinc-900 pb-6 last:border-0 last:pb-0"
                  >
              ...
              <div className="w-full max-w-xs space-y-4 text-sm tracking-widest uppercase">
                <div className="flex justify-between text-zinc-500">
                  ...
                  <span>
                    ...
                    {(
                      order.totalAmount -
                      (order.deliveryMethod === "IN_STORE" ? 0 : 6.5)
                    ).toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between text-zinc-500">
                  <span>SHIPPING</span>
                  <span>
                    {order.deliveryMethod === "IN_STORE" ? "FREE" : "€6.50"}
                  </span>
                </div>
          ...
          <div className="space-y-8">
            <div className="bg-[#050505] border border-zinc-900 p-8">
              ...
              <div className="space-y-4 text-sm tracking-wide">
                <div>
                  <p className="text-zinc-600 text-xs font-bold tracking-widest uppercase mb-1">
                    Name
                  </p>
            ...
            <div className="bg-[#050505] border border-zinc-900 p-8">
              ...
              <div className="space-y-4 text-sm tracking-wide">
                <div>
                  ...
                  <span className="px-2 py-1 bg-zinc-800 text-xs text-white font-bold uppercase tracking-widest">
                ...
                {order.deliveryMethod !== "IN_STORE" && (
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-zinc-300 uppercase leading-relaxed">
                        {(order as any).addressOrOffice || "N/A"}
                      </p>
                    </div>
                  </>
                )}
            ...
            <div className="bg-[#050505] border border-zinc-900 p-8">
              ...
              <div>
                ...
                <p className="text-white uppercase">
                  {(order as any).paymentMethod || "CASH ON DELIVERY"}
                </p>
              </div>
            </div>
          </div>
